...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/_app.laporan-penjualan/index.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1705419328766.5088";
}
var meta = () => {
  return [{
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Group, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ButtonDownload, { url: `/report-excel?data=penjualan&start=${start}&end=${end}` }, void 0, false, {
          fileName: "app/routes/_app.laporan-penjualan/index.tsx",
          lineNumber: 53,
          columnNumber: 6
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CustomTable, { mt: "sm", totalPagination: loader?.data?.pagination.pageCount || 0, header: ["No Nota", "Obat", "Tanggal", "Kuantitas", "Total"], children: loader?.data?.data?.map((data) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Table.Tr, { children: [
...
_s(LaporanPenjualan, "H7omMrUpVq0Uxi63I6WhFxntPFU=", false, function() {
  return [useTypedLoaderData, useDateRangeParamsInvalid];
});
_c = LaporanPenjualan;
var _c;
$RefreshReg$(_c, "LaporanPenjualan");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  LaporanPenjualan as default,
  meta
};
//# sourceMappingURL=/build/routes/_app.laporan-penjualan-Z3N2QVNT.js.map
