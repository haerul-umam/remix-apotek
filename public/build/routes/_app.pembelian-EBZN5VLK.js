...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/_app.pembelian/index.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1705419379125.5596";
}
var meta = () => {
  return [{
    title: "Data Pembelian"
  }, {
    content: "Master pembelian"
  }];
};
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Group, { justify: "space-between", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ButtonAdd, { label: "Tambah Pembelian", goTo: "tambah" }, void 0, false, {
          fileName: "app/routes/_app.pembelian/index.tsx",
          lineNumber: 52,
          columnNumber: 6
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CustomTable, { totalPagination: loader?.data?.pagination.pageCount || 0, header: ["No Faktur", "Obat", "Supplier", "Tanggal", "Kuantitas", "Total"], renderActionHeader: true, children: loader?.data?.data?.map((data) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Table.Tr, { children: [
...
_s(PembelianPage, "bOM/T8PrHqvD6m6bDFzkRcyRRb4=", false, function() {
  return [useTypedLoaderData, useFetcher];
});
_c = PembelianPage;
var _c;
$RefreshReg$(_c, "PembelianPage");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  PembelianPage as default,
  meta
};
//# sourceMappingURL=/build/routes/_app.pembelian-EBZN5VLK.js.map
