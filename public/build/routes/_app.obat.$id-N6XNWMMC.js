...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/_app.obat.$id/index.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1705419356717.9136";
}
function UpdateObat() {
...
var _c;
$RefreshReg$(_c, "UpdateObat");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  UpdateObat as default,
  meta
};
//# sourceMappingURL=/build/routes/_app.obat.$id-N6XNWMMC.js.map
