...
var Notifications = factory((_props, ref) => {
  ...
  const refs = (0, import_react7.useRef)({});
  const previousLength = (0, import_react7.useRef)(0);
  ...
  const items = data.notifications.map(({ style: notificationStyle, ...notification }) => /* @__PURE__ */ import_react7.default.createElement(
    Transition2,
    {
      key: notification.id,
      timeout: duration,
    ...
    (state) => /* @__PURE__ */ import_react7.default.createElement(
  ...
  return /* @__PURE__ */ import_react7.default.createElement(OptionalPortal, { withinPortal, ...portalProps }, /* @__PURE__ */ import_react7.default.createElement(Box, { ...getStyles("root"), ref, ...others }, /* @__PURE__ */ import_react7.default.createElement(TransitionGroup_default, null, items)));
});
...
//# sourceMappingURL=/build/_shared/chunk-J4BNWPQD.js.map
